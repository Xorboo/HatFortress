...
public class HelpScene3 extends CameraScene{
	...
	private void createText() {
		String txt = "Управлять игроком можно с помощью двух джойстивков. \n" +
					 "Левый позволяет двигать игрока в любом из возможных \n" +
					 "направлений и прыгать. Правый позволяет стрелять в \n" +
					 "указанном направлении. Иконки оружия сверху позволяют\n" +
					 "вызвать оружие. Граната и ракета нановят урон по" +
					 "площаде, автомат и дробовик - только по цели.";
